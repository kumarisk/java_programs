...
class Reg_Form extends JFrame implements ActionListener
{
	...
	ResultSet rs;
	Statement st1;
	JTextField CA,NOC,SUR,FNM,MNM,MOB,FAGE,FMOB,t1,t2,t3;
	JTextArea FNAME,AOC;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b1)
		{
			try
			{
				...
				Object Course_applied=c1.getSelectedItem();
				String Corse=Course_applied.toString();
				st.setString(2,Corse);
				...
				String First_name=FNM.getText();
				st.setString(4,First_name);
				//System.out.println(First_name);

				String Middle_name=MNM.getText();
				st.setString(5,Middle_name);
				//System.out.println(Middle_name);

				String address=AOC.getText();
				st.setString(6,address);
				//System.out.println(address);

				Object dd=c2.getSelectedItem();
				String dat=dd.toString();

				Object mm=c3.getSelectedItem();
				String mont=mm.toString();
				String str=dat.concat(mont);

				Object yyyy=c4.getSelectedItem();
				String yer=yyyy.toString();
				String txt=str.concat(yer);
				st.setString(7,txt);
				//System.out.println(txt);

				Object gen=c5.getSelectedItem();
				...
				Object c=c6.getSelectedItem();
				String Y=c.toString();
				st.setString(10,Y);
				//System.out.println(Y);

				Object univer=c7.getSelectedItem();
				String uni=univer.toString();
				st.setString(11,uni);
				//System.out.println(uni);

				Object yr=c8.getSelectedItem();
				String yea=yr.toString();
				st.setString(12,yea);
				//System.out.println(yea);

				String fnam=FNAME.getText();
				st.setString(13,fnam);
				...
				Object occu=c9.getSelectedItem();
				String occ=occu.toString();
				st.setString(15,occ);
				//System.out.println(occ);

				String fmob=FMOB.getText();
				st.setString(16,fmob);
				//System.out.println(fmob);
				int result=st.executeUpdate();
				System.out.println("\nNew Admission Registered: "+result);
				rs.close();
				st1.close();
				st.close();
				con.close();
