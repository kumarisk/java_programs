...
class Registration extends JFrame implements ActionListener
{
	...
	l1.setBounds(50,100,100,20);	l2.setBounds(50,130,150,20);	l3.setBounds(50,160,150,20);
	l4.setBounds(50,190,150,20);	l5.setBounds(50,220,100,20);	l6.setBounds(50,250,150,20);
	l7.setBounds(50,310,100,20);	l8.setBounds(50,340,50,20);		l9.setBounds(250,340,50,20);
	l10.setBounds(50,370,150,20);	l11.setBounds(50,400,50,20);	l12.setBounds(200,400,80,20);
	l13.setBounds(360,400,50,20);	l14.setBounds(50,430,150,20);	l15.setBounds(50,460,90,20);
	l16.setBounds(50,490,30,20);	l17.setBounds(170,490,70,20);	l18.setBounds(350,490,50,20);

	SUR.setBounds(200,160,300,20);	FNM.setBounds(200,190,300,20);	MNM.setBounds(200,220,300,20);
	AOC.setBounds(200,250,300,40);	MOB.setBounds(300,340,100,20);	FNAME.setBounds(170,460,300,20);
	FAGE.setBounds(100,490,50,20);	FMOB.setBounds(410,490,100,20);
	
	c1.setBounds(200,100,100,20);	c2.setBounds(170,310,40,20);	c3.setBounds(230,310,80,20);
	c4.setBounds(330,310,80,20);	c5.setBounds(130,340,80,20);	c6.setBounds(110,400,80,20);
	c7.setBounds(270,400,80,20);	c8.setBounds(390,400,40,20);	c9.setBounds(250,490,90,20);
	...
	add(p);
	add(p1);
	p.add(c1);	p.add(c2);	p.add(c3);	p.add(c4);		p.add(c5);	p.add(c6);	p.add(c7);	p.add(c8);	p.add(c9);
	p.add(NOC);	p.add(SUR);	p.add(FNM);	p.add(MNM);		p.add(AOC);	p.add(MOB); p.add(FAGE); 	p.add(FMOB);	p.add(FNAME);
	p.add(l1);	p.add(l2);	p.add(l3);	p.add(l4);	p.add(l5);	p.add(l6);	p.add(l7);	p.add(l8);	p.add(l9);	p.add(l10);
	p.add(l11);	p.add(l12);	p.add(l13); p.add(l14);	p.add(l15);	p.add(l16);	p.add(l17);	p.add(l18);	p.add(b1);
	p.setVisible(false);
	p1.setVisible(false);
	}
...
class createEx extends JPanel implements ActionListener
{
